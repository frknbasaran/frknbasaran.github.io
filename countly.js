    ...
    Countly.show_feedback_popup = function(id) {
        ...
        getWidget.onload = function() {
            if (getWidget.status === 200) {
                ...
                document.body.innerHTML += '<div id="cfbg"></div><div class="countly-iframe-wrapper" id="countly-iframe-wrapper-'+widget._id+'"><span class="countly-feedback-close-icon" id="countly-feedback-close-icon-'+widget._id+'">×</span><iframe name="countly-feedback-iframe" id="countly-feedback-iframe" src="'+"http://localhost:6001"+"/feedback?widget_id="+widget._id+"&app_key="+Countly.app_key+'&url='+Countly.url+'"></iframe></div>';
